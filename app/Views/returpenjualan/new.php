...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?= site_url('returpenjualan') ?>">
                    <?= csrf_field() ?>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_penjualan_tgl" required>
              ...
              <?php foreach ($dtpenjualan as $key => $value) : ?>
                <option value="<?= esc($value->id_penjualan) ?>" <?= old('id_penjualan_tgl') == $value->id_penjualan ? 'selected' : '' ?>>
                  <?= esc($value->tanggal) ?>
                </option>
              <?php endforeach; ?>    
            </select>    
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_penjualan_nota" required>
              ...
              <?php foreach ($dtpenjualan as $key => $value) : ?>
                <option value="<?= esc($value->id_penjualan) ?>" <?= old('id_penjualan_nota') == $value->id_penjualan ? 'selected' : '' ?>>
                  <?= esc($value->nota) ?>
                </option>
              <?php endforeach; ?>    
            </select>    
