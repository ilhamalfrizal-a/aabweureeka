...
<section class="section">
  <div class="section-header">
    <!-- <h1>APA INI</h1> -->
     <a href="<?= site_url('hasilsablon') ?>" class="btn btn-primary">
  ...
  <div class="section-body">
    ...
    <div class="card">
      <div class="card-header">
        <h4>Bahan Disablon</h4>
      </div>
      <div class="card-body">
        <form method="post" action="<?= site_url('hasilsablon') ?>">
          <?= csrf_field() ?>

          <div class="form-group">
            <label>Nota</label>
            <input type="text" class="form-control" name="nota_sablon" value="<?= old('nota_sablon') ?>" required>
          </div>

          <div class="form-group">
            <label>Bahan</label>
            <input type="text" class="form-control" name="bahan_sablon" value="<?= old('bahan_sablon') ?>" required>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="terpakai" value="<?= old('terpakai') ?>" required>
          </div>

          <div class="form-group">
            <label>Rusak</label>
            <input type="number" class="form-control" name="rusak" value="<?= old('rusak') ?>" required>
          </div>
