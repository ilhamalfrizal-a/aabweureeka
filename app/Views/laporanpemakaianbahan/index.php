...
<title>Akuntansi Eureeka &mdash; Laporan Pemakaian Bahan</title>
<?= $this->endSection(); ?>
...
<section class="section">
  ...
  <div class="section-body">
    <div class="card-body">
      <div class="row">
        <div class="col">
        <a href="<?= base_url('LaporanPemakaianBahan/printPDF?tglawal=' . $tglawal . '&tglakhir=' . $tglakhir) ?>" class="btn btn-success" target="_blank">
  ...
  <div class="section-body">
    <div class="card-body">
    <form action="<?= site_url('laporanpemakaianbahan') ?>" method="POST">
   <?= csrf_field() ?>
   <div class="row g-3">
      <div class="col">
