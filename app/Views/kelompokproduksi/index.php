...
<section class="section">
  <div class="section-header">
    <!-- <h1>APA INI</h1> -->
     <a href="<?=site_url('kelompokproduksi/new')?>" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
  </div>
                        ...
                        <tr>
                          ...
                          <td class="text-center">
                            ...
                            <form action="<?= site_url('kelompokproduksi/'.$value->id_kelproduksi) ?>" method="post" id="del-<?=$value->id_kelproduksi?>" class="d-inline">
                              ...
                              <button class="btn btn-danger btn-small" data-confirm="Hapus Data....?" data-confirm-yes="hapus(<?=$value->id_kelproduksi?>)"><i class="fas fa-trash"></i></button>
                            </form>
                          </td>
