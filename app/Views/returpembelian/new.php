...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="<?= site_url('returpembelian') ?>">
                    <?= csrf_field() ?>
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_pembelian_tgl" required>
              ...
              <?php foreach ($dtpembelian as $key => $value) : ?>
                <option value="<?= esc($value->id_pembelian) ?>" <?= old('id_pembelian_tgl') == $value->id_pembelian ? 'selected' : '' ?>>
                  <?= esc($value->tanggal) ?>
                </option>
              <?php endforeach; ?>    
            </select>    
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="id_pembelian_nota" required>
              ...
              <?php foreach ($dtpembelian as $key => $value) : ?>
                <option value="<?= esc($value->id_pembelian) ?>" <?= old('id_pembelian_nota') == $value->id_pembelian ? 'selected' : '' ?>>
                  <?= esc($value->nota) ?>
                </option>
              <?php endforeach; ?>    
            </select>    
